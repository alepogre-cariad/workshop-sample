---
title: "GENCOST04-BP01 Reduce vector length on embedded tokens - Generative AI Lens"
source: "https://docs.aws.amazon.com/wellarchitected/latest/generative-ai-lens/gencost04-bp01.html"
author:
published:
created: 2026-06-21
description: "Using a smaller vector size for data embeddings results in a reduced response length for data-driven generative AI workflows. By keeping vector lengths small, we can save on model output as well as vector database computation requirements."
tags:
  - "clippings"
---
GENCOST04-BP01 Reduce vector length on embedded tokens - Generative AI Lens
...
- [Measure overall efficiency](https://docs.aws.amazon.com/wellarchitected/latest/framework/cost-dp.html) - Vector stores introduce a new component for cost optimization into a generative AI application. By increasing the efficiency of a vector store, you also optimize the cost of running your application.
- [Analyze and attribute expenditure](https://docs.aws.amazon.com/wellarchitected/latest/framework/cost-dp.html) - Reducing vector length can help to lower the costs attributed to a vector store.
